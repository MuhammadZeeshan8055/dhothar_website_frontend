          ...
          <ul class="navigation">
            ...
            <li class="dropdown">
              <a href="/japan_introduction">
                <img src="/assets/images/dhothar_images/jp-flag.jpg" width="35" style="vertical-align: middle;" />
                &nbsp;&nbsp; JAPAN
              </a>
              <ul>
        ...
        <ul class="contact-list-one">
          <li>
            <div class="contact-info-box">
              ...
              <a href="tel:+92880098670">Pak +92514848692<br />Romanian +40739916997<br />UAE +971501005758</a>
            </div>
          </li>
          <li>
            <div class="contact-info-box">
            ...
            <nav class="main-menu">
              <div class="navbar-collapse show collapse clearfix">
                <ul class="navigation clearfix">
                  <li><div id="google_element"></div></li>
                </ul>
              </div>
            </nav>
            <div class="mobile-nav-toggler"><span class="icon lnr-icon-bars"></span></div>
