...
<head>
<meta charset="utf-8">
<title>Disle | Design Agency HTML Template | Home Page 04</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
	...
	<header class="main-header header-style-four">
		...
		<div class="main-box">
			...
			<div class="outer-box">
				...
				<a href="#" class="theme-btn btn-style-one dark-bg"><span class="btn-title">Get a quote</span></a>
				...
				<ul class="contact-list-one">
					...
					<li>
						...
						<div class="contact-info-box">
							...
							<a href="/cdn-cgi/l/email-protection#e088858c90a0838f8d90818e99ce838f8d"><span class="__cf_email__" data-cfemail="731b161f0333101c1e03121d0a5d101c1e">[email&#160;protected]</span></a>
						</div>
					</li>
					<li>
						<!-- Contact Info Box -->
	...
	<section class="banner-section-three">
		<div class="banner-carousel owl-carousel owl-theme default-navs">
			...
			<div class="slide-item">
				<div class="bg-image" style="background-image: url(assets/images/main-slider/5.jpg);"></div>
				<div class="auto-container">
					<div class="content-box">
						<span class="sub-title animate-1">Smart Digital Marketing Agency</span>
						<h1 class="title animate-2">Shaping the <br>Perfect Website <br>Solutions.</h1>
	...
	<section class="features-section p-0">
		<div class="row g-0">
			<!-- Feature Block Four -->
			<div class="feature-block-four col-xl-4 col-lg-4 col-md-6">
				<div class="inner-box">
					<div class="content-box">
						<div class="icon-box"><i class="icon flaticon-discuss"></i></div>
						<h5 class="title">Experienced Members</h5>
						<div class="text">Lorem ipsum is fre dolor sit amet cectetuer adipiscing elit, sed diam nibh.</div>
					</div>
				</div>
			</div>
			<!-- Feature Block Four -->
			<div class="feature-block-four col-xl-4 col-lg-4 col-md-6">
				<div class="inner-box">
					<div class="content-box">
						...
						<h5 class="title">24/7 Support & Services</h5>
						<div class="text">Lorem ipsum is fre dolor sit amet cectetuer adipiscing elit, sed diam nibh.</div>
					</div>
				</div>
			</div>
			...
			<div class="feature-block-four col-xl-4 col-lg-4 col-md-6">
				<div class="inner-box">
					<div class="content-box">
						<div class="icon-box"><i class="icon flaticon-programmer"></i></div>
	...
	<section class="about-section-five">
		<div class="auto-container">
			...
			<div class="row">
				<!-- Content Column -->
				<div class="content-column col-lg-6 col-md-12 col-sm-12 wow fadeInLeft order-2">
					<div class="inner-column">
						<div class="sec-title">
							<span class="sub-title">Welcome to disle</span>
							<h2>Welcome to Best Digital Marketing Agency.</h2>
						...
						<blockquote class="blockquote-style-one">
							You can simplifying your design & development needs with a personal
							approach on disle company.
						</blockquote>
						...
						<div class="skills">
							<div class="row">
									...
									<div class="skill-item">
										<div class="skill-header">
											...
											<div class="skill-percentage">
												<div class="count-box"><span class="count-text" data-speed="3000" data-stop="66">0</span>%</div>
											</div>
										</div>
										<div class="skill-bar">
											<div class="bar-inner">
												<div class="bar progress-line" data-width="66">
												</div>
											</div>
										</div>
									</div>
								...
								<div class="col-lg-6">
									...
									<div class="skill-item">
										<div class="skill-header">
											<div class="skill-title">Designing</div>
											<div class="skill-percentage">
				...
				<div class="image-column col-lg-6 col-md-12 wow fadeInLEft" data-wow-delay="600ms">
					<div class="inner-column">
						<figure class="image-1 overlay-anim"><img src="images/resource/about4-1.jpg" alt=""></figure>
						<figure class="image-2 overlay-anim"><img src="images/resource/about4-2.jpg" alt=""></figure>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="auto-container">
			...
			<div class="row">
				...
				<div class="service-block-four col-lg-3 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><a href="page-service-details.html"><img src="images/resource/service2-1.jpg" alt=""></a></figure>
						</div>
						<div class="content-box">
				...
				<div class="service-block-four col-lg-3 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><a href="page-service-details.html"><img src="images/resource/service2-2.jpg" alt=""></a></figure>
						</div>
						<div class="content-box">
				...
				<div class="service-block-four col-lg-3 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><a href="page-service-details.html"><img src="images/resource/service2-3.jpg" alt=""></a></figure>
						</div>
						<div class="content-box">
				...
				<div class="service-block-four col-lg-3 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><a href="page-service-details.html"><img src="images/resource/service2-4.jpg" alt=""></a></figure>
						</div>
						<div class="content-box">
		...
		<div class="auto-container">
			<div class="row">
				...
				<div class="content-column col-lg-5 col-md-12">
					<div class="inner-column">
						<div class="sec-title light">
							<span class="sub-title">Watch us live</span>
							<h2> Agency that Gets <br> Excited About.</h2>
						...
						<ul class="list-style-two">
							<li><i class="fa fa-arrow-alt-circle-right"></i> Urgent development solutions</li>
							<li><i class="fa fa-arrow-alt-circle-right"></i> Top quality services with reasonable price</li>
							<li><i class="fa fa-arrow-alt-circle-right"></i> Professional & experienced team</li>
						</ul>

						<a href="page-contact.html" class="theme-btn btn-style-one dark-bg hover-light"><span class="btn-title">Discover more</span></a>
					</div>
				</div>
				...
				<div class="image-column col-lg-7 col-md-12">
					<div class="inner-column">
						<div class="image-box">
							<figure class="image"><img src="images/resource/why-us-3.jpg" alt=""></figure>
							<div class="video-box">
								<a href="https://www.youtube.com/watch?v=Fvae8nxzVz4" class="play-icon lightbox-image" ><i class="icon fa fa-play"></i></a>
								<h4 class="title">We Do More then Platforms</h4>
							</div>
						</div>
					</div>
				</div>
	...
	<section class="work-section">
		<div class="auto-container">
			<div class="sec-title text-center">
				...
				<h2>Get your Website Done <br>in 3 Simple Steps.</h2>
			</div>
			...
			<div class="bottom-text">
				...
				<a href="page-services.html" class="theme-btn">Find Your Solution</a>
			</div>
		</div>
	</section>
	<!-- End Work Section -->
				...
				<div class="content-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column">
						<div class="sec-title light">
							...
							<h2>We Create Opportunity to Grow Business.</h2>
							<div class="text">Lorem ipsum is simply free text available used by copy typing refreshing. Neque porro noting est qui dolorem ipsum quia.</div>
						</div>
						...
						<div class="row">
							...
							<div class="info-block col-lg-6 col-md-6">
								<div class="inner">
									<i class="icon flaticon-front-end"></i>
									<h4 class="title">Control <br>Development</h4>
								</div>
							</div>
							...
							<div class="info-block col-lg-6 col-md-6">
								<div class="inner">
									...
									<h4 class="title">Productive <br>Platform</h4>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="contact-form style-two wow fadeInLeft">
							...
							<form method="post" action="get" id="contact-form">
								<div class="row">
									...
									<div class="form-group col-lg-12">
										<button class="theme-btn btn-style-one dark-bg hover-light" type="submit" name="submit-form"><span class="btn-title">Send a message</span></button>
									</div>
								</div>
							</form>
						</div>
	...
	<!-- Testimonial Section -->
	<section class="testimonial-section-three pb-0">
			...
			<div class="carousel-outer">
				<div class="testimonial-carousel owl-carousel">
					...
					<div class="testimonial-block">
						<div class="inner-box">
							<div class="content-box">
								<div class="text">I was very impresed by the digital services lorem ipsum is simply free text available used by copy typing refreshing. Neque porro noting est qui dolorem ipsum quia.</div>
							</div>
							<div class="info-box">
	...
	<!-- News Section -->
	<section class="news-section-two pb-0">
		...
		<div class="auto-container">
			...
			<div class="row">
				...
				<div class="news-block-two col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><a href="news-details.html"><img src="images/resource/news2-1.jpg" alt=""></a></figure>
						...
						<div class="content-box">
							...
							<h5 class="title"><a href="news-details.html">Five ways that can develop your business website</a></h5>
						</div>
					</div>
				</div>
			   ...
			   <!-- News Block -->
				<div class="news-block-two col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><a href="news-details.html"><img src="images/resource/news2-2.jpg" alt=""></a></figure>
							<span class="date">20 Mar, 2023</span>
						</div>
						<div class="content-box">
							<div class="info-box">
				...
				<div class="news-block-two col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><a href="news-details.html"><img src="images/resource/news2-3.jpg" alt=""></a></figure>
							<span class="date">20 Mar, 2023</span>
						</div>
						<div class="content-box">
							<div class="info-box">
			...
			<div class="call-to-action">
				<div class="outer-box">
					...
					<div class="title-box">
						...
						<a href="page-contact.html" title="" class="theme-btn btn-style-one dark-bg hover-light"><span class="btn-title">discover more</span></a>
					</div>
					<div class="image-box">
						<span class="icon icon-bulb"></span>
						<figure class="image"><img src="images/resource/woman.png" alt=""></figure>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					...
					<div class="contact-info-block col-lg-4 col-md-6">
						<div class="inner">
							...
							<div class="text">
								<a href="#"><span class="__cf_email__" data-cfemail="6c020909080409001c2c0f03011c0d0215420f0301">[email&#160;protected]</span></a>
